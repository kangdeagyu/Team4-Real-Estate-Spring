...
<%
	...
	//conn.voidEval("around30_rf <- readRDS(url('http://localhost:8080/Rserve/around30.rds','rb'))");
	conn.voidEval("around30_rf <- readRDS('classpath:rds/around30.rds')");


	conn.voidEval("result <- predict(around30_rf, list(주변정류장개수=" + busStations + ", 역거리= " + distance + ", 경도 = " + y + ", 위도 = " + x +
